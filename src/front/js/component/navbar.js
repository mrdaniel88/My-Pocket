...
export const Navbar = () => {
	return (
		...
		// 		<a class="navbar-brand" href="#">My Pocket</a>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="#"><i className="side-icon fa-solid fa-house"></i></a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#"><i className="side-icon fa-solid fa-chart-pie"></i></a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#"><i className="side-icon fa-solid fa-plus"></i></a>
						</li>
						<li class="nav-item">
